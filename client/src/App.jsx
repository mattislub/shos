...
const StorePage = () => {
  ...
  const CartSidebar = () => (
    <aside className="cart-sidebar" aria-label="Cart summary">
      ...
      <p className="cart-sidebar-total">Products total: {formatUsdCents(cartTotalUsd)}</p>
      <p className="cart-sidebar-total">Shipping: {formatUsdCents(shippingPriceUsd)}</p>
      <p className="cart-sidebar-total">Order total: {formatUsdCents(cartTotalUsd + shippingPriceUsd)}</p>
      <button
        type="button"
      ...
      <main className="page product-page">
        ...
        <section className="card product-step-page" aria-label="Product page">
          ...
          <section className="product-step-image-block" aria-label="Product image">
            ...
            <p className="status">Total with shipping: {formatUsdCents((currentProduct.price_usd || 0) + shippingPriceUsd)}</p>
          </section>
